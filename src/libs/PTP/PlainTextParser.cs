...
namespace PTP {
    /// <summary> Implements a plain text parser. </summary>
    public class PlainTextParser {
        private static PlainTextParser _instance;

        /// <summary> Returns the instance of the parser. </summary>
        public static PlainTextParser Instance 
            => _instance ?? (_instance = new PlainTextParser());
        ...
        /// <summary> Parses the given stream with the given splitter tokens. </summary>
        ...
        /// <param name="inlineSplitter">Splitter tokens for inline value enumerations</param>
        /// <returns>Instance of IPlainTextDocument with the parsed values</returns>
        public IPlainTextDocument Parse(Stream stream, string[] blockSplitter, string[] chunkSplitter,
            string[] nlNoBlock, string[] inlineSplitter) {
        ...
        /// <summary> Parses the given string and creates an instance of <see cref="Chunk"/> </summary>
