...
namespace motoi.plugins {
    /// <summary>
    /// Defines an exception that indicates an error
    /// during the activation process of a plug-in.
    /// </summary>
    public class PluginActivationException : Exception {
        /// <summary> Creates a new instance with the given <paramref name="message"/>. </summary>
        ...
        /// and predecessing <paramref name="innerException"/>.
        /// </summary>
        /// <param name="message">Exception message</param>
