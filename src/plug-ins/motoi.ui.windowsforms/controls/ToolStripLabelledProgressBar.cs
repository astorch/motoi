...
namespace motoi.ui.windowsforms.controls {
    ...
    public class ToolStripLabelledProgressBar : ToolStripControlHost {
        ...
        /// <summary> Returns the underlying control panel. </summary>
        private TableLayoutPanel ControlPanel 
            => (TableLayoutPanel) Control;

        /// <summary> Returns the label control that displays the progress hint. </summary>
        private Label ProgressHintLabel 
            => (Label) ControlPanel.Controls[1];

        /// <summary> Returns the progress bar control. </summary>
        private TextProgressBar ProgressBar
            => (TextProgressBar) ControlPanel.Controls[2];

        /// <summary> Returns TRUE, when the progress is indetermine or does set it. </summary>
        public bool IsIndetermine {
            get { return ProgressBar.IsIndetermine; }
            set { ProgressBar.IsIndetermine = value; }
        }

        /// <summary> Returns the current progress hint or does set it. </summary>
        public string ProgressHint {
            get { return ProgressHintLabel.Text; }
            set { ProgressHintLabel.Text = value; }
        }

        /// <summary> Returns the current progress value or does set it. </summary>
        public ushort ProgressValue {
            get { return (ushort) ProgressBar.Value; }
            set { ProgressBar.Value = value; }
        }

        /// <summary> Returns the current progress text or doest set it. </summary>
        ...
        /// <summary> Creates the underlying control instance that is bound by control host. </summary>
