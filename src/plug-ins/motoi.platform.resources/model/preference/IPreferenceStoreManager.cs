...
namespace motoi.platform.resources.model.preference {
    ...
    public interface IPreferenceStoreManager : IDisposable, IInitializable {
        /// <summary>
        /// Returns an instance of <see cref="IPreferenceStore"/> for the given <paramref name="storeName"/> and 
        /// <paramref name="storeScope"/>. 
        /// Note, even if there hasn't been a store before, a new one is created. So this method always returns 
        /// an operable instance. The location the store saves its settings is parametrized using the <paramref name="storeScope"/>. 
        /// </summary>
