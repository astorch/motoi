...
namespace motoi.platform.ui.widgets {
    ...
    /// <summary>
    /// Provides the property meta data of <see cref="IButton"/> that is used by data binding operations.
    /// </summary>
    public class PButton : PWidgetControl<IButton> {
        ...
        public static readonly IBindableProperty<IActionHandler> ActionHandlerProperty = CreatePropertyInfo(_ => _.ActionHandler, null);
    }
}