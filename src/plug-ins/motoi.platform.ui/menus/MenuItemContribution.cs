...
namespace motoi.platform.ui.menus {
    /// <summary>
    /// Defines a menu item contribution.
    /// </summary>
    public class MenuItemContribution {
        ...
        public MenuItemContribution(string id, string label, string menu, IActionHandler handler, string shortcut, Stream imageStream) {
            Id = id;
            Label = label;
            Menu = menu;
        ...
        /// </summary>
        public IActionHandler ActionHandler { get; private set; }
