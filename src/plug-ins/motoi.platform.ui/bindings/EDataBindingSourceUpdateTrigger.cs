...
namespace motoi.platform.ui.bindings {
    ...
    public class EDataBindingSourceUpdateTrigger : XEnum<EDataBindingSourceUpdateTrigger> {
        ...
        /// <summary>
        /// Updates the binding source when the binding target property changes but not every time. This reduces frequent invocations.
        /// </summary>
