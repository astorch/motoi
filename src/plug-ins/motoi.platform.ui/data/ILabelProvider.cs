...
namespace motoi.platform.ui.data {
    ...
    public interface ILabelProvider {
        ...
        /// <summary>
        /// Return an <see cref="ImageDescriptor"/> for the <paramref name="item"/>. If you return NULL, 
        /// no image is shown.
        /// </summary>
        /// <param name="item">Item</param>
        ...
        /// <summary>
        /// Return the tooltip for the item. If you return NULL the default text is used.
        /// </summary>
        /// <param name="item">Item</param>
