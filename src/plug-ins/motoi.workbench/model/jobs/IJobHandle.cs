...
namespace motoi.workbench.model.jobs {
    /// <summary> Implements a handle for a job that has being scheduled for execution. </summary>
    public interface IJobHandle {
        ...
        /// <summary> Blocks the current thread until the associated job has been executed. </summary>
        void Wait();

        /// <summary> Cancels the execution of the associated job. </summary>
        void Cancel();
    }
}